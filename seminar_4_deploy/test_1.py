...
class TestPositive:
   ...
   def test_step1(self, start_time: str):
       res = []
   ...
   def test_step2(self, make_folders: bool, clear_folders: bool, make_files: list, start_time: str):
   ...
   def test_step3(self, clear_folders: bool, make_files: list, start_time: str):
       res = []
   ...
   def test_step4(self, start_time: str):
   ...
   def test_step5(self, start_time: str):
   ...
   def test_step6(self, clear_folders: bool, make_files: list, start_time: str):
       res = []
       res.append(ssh_checkout(data["ip"], data["user"], data["passwd"], "cd {}; 7z a "
           "{}/arx2".format(data["folder_in"], data["folder_out"]), "Everything is Ok"))
       for item in make_files:
   ...
   def test_step7(self, clear_folders: bool, make_files: list, make_subfolder: tuple[None, None] | tuple[str, None] | tuple[str, str], start_time: str):
       res = []
       res.append(ssh_checkout(data["ip"], data["user"], data["passwd"], "cd {}; 7z a "
   ...
   def test_step8(self, start_time: str):
   ...
   def test_step9(self, clear_folders: bool, make_files: list, start_time: str):
   ...
   def test_step10(self, start_time: str):
       res = []
